...
<img src="{{ site.url }}{{ site.baseurl }}/images/teampic/group_photo.jpg" class="img-responsive" width="60%" style="float: center; margin-center: 2rem; border-radius: 8px; box-shadow: 5px 5px 5px #ccc;" />
